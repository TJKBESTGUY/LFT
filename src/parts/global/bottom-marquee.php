...
<?php   if ( is_page( array( 'etusivu', 'contact', 'management' ) ) ) { ?>
  ...
  <span class="-type">
    ...
    <span class="-name">
      Finlandia-talo
          ...
          <div class="U_container U_base-pad">
  <div class="module--refe-preview-txt">

    <h3>Olemme laskeneet määräluettelot muun muassa näihin kohteisiin. Referessit-sivulta löydätte lisää esimerkkejä lasketuista kohteista, joiden määrälaskenta on toteutettu hyvässä yhteistyössä asiakkaiden kanssa.</h3>
