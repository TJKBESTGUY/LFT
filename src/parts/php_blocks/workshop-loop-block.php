       ...
       <?php $count_posts = wp_count_posts( 'valmennukset' )->publish; ?>
                       ...
                       $var_valmennukset = get_terms( array(
                         ...
                         <div class="workshop-nav">
                            <button @click="resetTaxFilters"  class="btn--basic btn--outline" type="button" name="button" data-tax="">Kaikki<span> (<?php echo $count_posts ?>)</span> </button>
