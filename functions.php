...
<channel>
	...
	<lastBuildDate><?php echo mysql2date( 'D, d M Y H:i:s +0400', get_post_field( 'post_modified', "151" ), false ); ?></lastBuildDate>
...
<pubDate><?php echo mysql2date( 'D, d M Y H:i:s +0400', get_post_field( 'post_modified', "151" ), false ); ?></pubDate>
