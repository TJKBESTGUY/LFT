<?php
  ...
  <div class="module--heading_txt floating-heading">
      ...
      <div class="heading">
    <h3>Rakentamisen kustannukset täsmentyvät, kun määräluettelo on laskettu tarkasti ja luotettavasti</h3>
      </div>
  </div>
</div>
</div>
                ...
                <div class="module--split-content " style="padding-left:8.333%">
                      <div class="flx-container">
                        <div class="cell mosaic-split__txt split-content__txt">
                          ...
                          <p class="">Jokainen sentti ja sekunti ratkaisee tarjousvaiheessa, joten teemme perinpohjaista työtä sovitusti. Kerralla valmis, virheetön ja vaatimusten mukainen.
                          </p>
                          <p>Yhteistyöhön pohjautuvan kehitystyön myötä, olemme kehittäneet palvelumme mahdollisimman helppokäyttöisiksi asiakkaillemme läpi koko projektin.</p>
