<?php
      ...
      <section class="section--basic U-sec-pad">
        <div class="U_container U_base-pad">
          ...
          <section class="section--basic U-sec-pad__small">
                    <div class="U_container U_base-pad">
      <div class="module--heading_txt">
      <!-- <div class="heading-content -left-nudge heading-content--floating" style="margin-left:16.66%;padding-left:80px;margin-top:40px;"> -->
          <div class="heading-content -left-nudge heading-content--floating" style="margin-left:8.33%;margin-top:40px;">
          <div class="heading">
  ...
  <picture>
    <source media="(min-width:650px)" data-srcset="<?php echo get_template_directory_uri(); ?>/images/b4.jpg">
      ...
      <section class="section--basic U-sec-pad">
        <div class="U_container U_base-pad">
          <div class="module--heading_txt" style="margin-left:8.333333333%;" >
            <div class="heading-content">
                <div class="heading">
              <h2>Pysymme ajan tasalla siitä, missä rakennetaan</h2>
                </div>
      ...
      <section class="section--basic U-sec-pad" style="padding-top:80px;">
        <div class="U_container U_base-pad">
          <div class="module--heading_txt" >
  ...
  <picture>
    <source media="(min-width:650px)" data-srcset="<?php echo get_template_directory_uri(); ?>/images/b4.jpg">
      ...
      <section class="section--basic U-sec-pad" style="padding-top:0px;">
        <div class="U_container U_base-pad">
          <div class="module--full-image" style="padding-left:16.66%; padding-right: 8.33%" >
            <div class="image-aspect-box ">
  <div class="image-aspect-box_inner">
  <picture>
      ...
      <source media="(min-width:465px)" data-srcset="<?php echo get_template_directory_uri(); ?>/images/b4.jpg">
        <img class="lazy-anim lazyload" data-src="<?php echo get_template_directory_uri(); ?>/images/b4.jpg" alt="" src="">
            ...
            <div class="cell split-content__txt">
              <div class="cell_txt-content">
              <!-- <h3>Täsmällisyys on meille kaikki kaikessa.</h3> -->
              <p class="cell-p">Etsimme aina tapoja kehittää toimintaamme, jotta voimme palvella rakentajia vielä paremmin. Edistämme niin tapoja laskea kuin määrälaskentaohjelmistoja. Oma väkemme on olennaisessa roolissa kehittämässä, jotta voimme aina hyödyntää laajaa kokemustamme</p>
              <div class="capsule-wrap">
                <button class="basic-btn btn--yellow"type="button" name="button"><span class="basic-btn__text">Lue lisää</span> <span class="basic-btn__icon">
                  <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><path d="M9,.5A8.5,8.5,0,1,0,17.5,9,8.51,8.51,0,0,0,9,.5Zm1.08,12.93-.91-.94L12,9.7H3.83V8.32H12L9.17,5.51l.91-.94L14.48,9Z"/></svg>
                </span> </button>
    ...
    <source media="(min-width:650px)" data-srcset="<?php echo get_template_directory_uri(); ?>/images/b4.jpg">
      <source media="(min-width:465px)" data-srcset="<?php echo get_template_directory_uri(); ?>/images/b4.jpg">
        <img class="lazy-anim lazyload" data-src="<?php echo get_template_directory_uri(); ?>/images/b4.jpg" alt="" src="">
            ...
            <div class="cell split-content__txt">
              <div class="cell_txt-content">
              <h3>Tarkkuus palkitsee läpi rakennushankkeen</h3>
              <p class="cell-p">Luotettava määräluettelo on laadukkaan rakentamisen perusta. Olemme yli 30 vuoden ajan kehittäneet määräluettelomme auttamaan rakennushankkeiden alusta loppuun. Meillä on kokemusta määräluetteloiden laskemisesta kaikenkokoiseen rakentamiseen. Kun teemme työmme huolella ja tarkkuudella, niin asiakkaamme voivat keskittyä olennaiseen omassa työssään.</p>
              <div class="capsule-wrap">
                <button class="basic-btn btn--yellow"type="button" name="button"><span class="basic-btn__text">Lue lisää</span> <span class="basic-btn__icon">
                  <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18"><path d="M9,.5A8.5,8.5,0,1,0,17.5,9,8.51,8.51,0,0,0,9,.5Zm1.08,12.93-.91-.94L12,9.7H3.83V8.32H12L9.17,5.51l.91-.94L14.48,9Z"/></svg>
                </span> </button>
          ...
          <div class="module--split-content">
            ...
            <div class="cell split-content__txt">
              <div class="cell_txt-content">
                <h3>Olemme toimittaneet yli 10 000 määräluetteloa.</h3>
              <p class="cell-p">Niiden varassa rakennusprojekteja on viety tarjousvaiheen kautta valmiisiin kohteisiin.
                Määräluettelo toimii rakentamisen pohjana niin kustannuslaskennassa kuin työmaasuunnitteluissa ja hankinnoissa. Kerralla tarkka, pitkään toimiva.
              </p>
            </div>
              </div>
