...
<section class="section--modal js--hide-modal" @click.self="hideModal">
  <div class="U_container U_base-pad js--hide-modal" @click.self="hideModal">
    <div class="module--modal-content">
      <button class=" btn--hide-modal js--hide-modal__btn" type="button" name="button" @click="hideModal">
        <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2.222 17.778L17.778 2.222M2.222 2.222l15.556 15.556" stroke="black" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round"></path>
        </svg>
      </button>
      <div class="modal-contact-form S-hidden">
